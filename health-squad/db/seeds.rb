...
Medication.create(name:"Brimonidine-Timolol 0.2%-0.5% ", description:"Drops", dosage:"n/a", directions:"instill 1 drop in both eyes twice per day", count:0)
...
Medication.create(name:"Sertraline HCL 25 MG Tablet", description:"Tablet", dosage:"25 MG", directions:"take 1 tablet per day", count:30)
...
Medication.create(name:"Tri-Sprintec Tab Tev", description:"Tablet", dosage:"n/a", directions:"take 1 tablet per day", count:0)
